...
struct cam_sensor_i2c_reg_array load_sensor_gc08a3_otp_setfile_reg[] = {
    {0x031c, 0x60},
    {0x0337, 0x03},
    {0x0335, 0x51},
    {0x0336, 0x6a},
...
struct cam_sensor_i2c_reg_array gc08a3_otp_init_write_reg[] = {
    
};

struct cam_sensor_i2c_reg_array gc08a3_otp_finish_write_reg[] = {

};

struct cam_sensor_i2c_reg_array gc08a3_otp_init_read_reg[] = {
	{0x0324, 0x42},
	{0x0316, 0x09},
	{0x0a67, 0x80},
	{0x0313, 0x00},
...
struct cam_sensor_i2c_reg_array gc08a3_otp_finish_read_reg[] = {
